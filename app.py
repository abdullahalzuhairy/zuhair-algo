...
<style>
:root { --bg: #0d1117; --panel: #161b22; --border: #30363d; --text: #c9d1d9; --text-muted: #8b949e; --up: #3fb950; --down: #f85149; --neutral: #d2a8ff; --poi: #58a6ff; --gold: #e3b341; --header-bg: #21262d; --font-mono: 'Consolas', 'Courier New', monospace; --font-sans: 'Tajawal', sans-serif; }
...
.dashboard-top { display: grid; grid-template-columns: 1fr; gap: 20px; margin-bottom: 20px; }
